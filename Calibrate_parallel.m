...
try    
    ...
    num_vars = length(size(info.Variables));
...
elseif(strcat(info.Variables(num_vars).Name,'4_Derived_plate_factor'))
    disp('Day has already been processed');
else
    disp('Uknown variable structure');    
end
catch ME
